...
{do}[{trang}{kt_code}{do}] \033[1;35mADMIN:\033[1;36m Schooldev
{do}[{trang}{kt_code}{do}] {dac_biet}TIKTOK:\033[1;37m Schooldev
\033[1;37m────────────────────────────────────────────────────────────"""
...
def rpsm_loop():
    ...
    while True:
        initial = reqs
        time.sleep(0.5)  # Decreased sleep time to 0.5 seconds
        rps = round((reqs - initial) / 0.5, 1)
        rpm = round(rps * 60, 1)
